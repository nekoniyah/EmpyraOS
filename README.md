...
Philosophical Review: Review the core pillars and architectural model. Are there any potential security or performance pitfalls in this hybrid approach?

Design Specification: Help flesh out the User Interface (UI) and User Experience (UX) to reflect the OS's philosophy (e.g., how does the user manage container permissions visually?).

Future Protocol Definition: Help define the requirements for the "New Internet" networking stack.
